 ...
 */
final class Version20250508155628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE agency (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_70C0C6E6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE hotels (id_hotel INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, rating INT NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, type_room VARCHAR(255) NOT NULL, num_room INT NOT NULL, image VARCHAR(255) DEFAULT NULL, agency_id INT DEFAULT NULL, INDEX IDX_E402F625139DF194 (promotion_id), PRIMARY KEY(id_hotel)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE offer_travel (id INT AUTO_INCREMENT NOT NULL, agency_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, departure VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, departure_date DATE NOT NULL, arrival_date DATE NOT NULL, hotel_name VARCHAR(255) NOT NULL, discription LONGTEXT NOT NULL, category VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, flight_name VARCHAR(255) NOT NULL, INDEX IDX_F45E1C6FCDEADB2A (agency_id), INDEX IDX_F45E1C6F139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, discount_percentage DOUBLE PRECISION NOT NULL, valid_until DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE reservation (id_reservation INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, travel_id INT NOT NULL, status VARCHAR(255) NOT NULL, orderDate DATE NOT NULL, ticket_id INT NOT NULL, hotel_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, places VARCHAR(255) NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), PRIMARY KEY(id_reservation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE service_reservation (id_servicereservation INT AUTO_INCREMENT NOT NULL, service VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id_servicereservation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE tickets (id_ticket INT AUTO_INCREMENT NOT NULL, flight_number INT NOT NULL, airline VARCHAR(255) NOT NULL, departure_city VARCHAR(255) NOT NULL, arrival_city VARCHAR(255) NOT NULL, departure_date DATE DEFAULT NULL, departure_time VARCHAR(8) NOT NULL, arrival_date DATE DEFAULT NULL, arrival_time VARCHAR(8) NOT NULL, ticket_class VARCHAR(50) NOT NULL, price DOUBLE PRECISION NOT NULL, ticket_type VARCHAR(50) NOT NULL, image_airline VARCHAR(255) DEFAULT NULL, city_image VARCHAR(1000) DEFAULT NULL, agency_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, PRIMARY KEY(id_ticket)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hotels ADD CONSTRAINT FK_E402F625139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE hotels DROP FOREIGN KEY FK_E402F625139DF194
        SQL);
        $this->addSql(<<<'SQL'
